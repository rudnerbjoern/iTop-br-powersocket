...
Dict::Add('EN US', 'English', 'English', array(
    ...
    'Class:PowerSocket/Attribute:feed'  => 'Power feed',
    'Class:PowerSocket/Attribute:feed+' => 'Electrical feed of this socket (e.g. A or B).',
    'Class:PowerSocket/Attribute:feed/Value:A' => 'Feed A',
    'Class:PowerSocket/Attribute:feed/Value:A+' => 'Primary power feed (A).',
    'Class:PowerSocket/Attribute:feed/Value:B' => 'Feed B',
    'Class:PowerSocket/Attribute:feed/Value:B+' => 'Secondary / redundant power feed (B).',
