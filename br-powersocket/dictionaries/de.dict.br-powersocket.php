...
Dict::Add('DE DE', 'German', 'Deutsch', array(
    ...
    'Class:PowerSocket/Attribute:feed'  => 'Einspeisung',
    'Class:PowerSocket/Attribute:feed+' => 'Elektrische Einspeisung dieses Anschluss (z. B. A oder B).',
    'Class:PowerSocket/Attribute:feed/Value:A' => 'Feed A',
    'Class:PowerSocket/Attribute:feed/Value:A+' => 'Primäre Einspeisung (A).',
    'Class:PowerSocket/Attribute:feed/Value:B' => 'Feed B',
    'Class:PowerSocket/Attribute:feed/Value:B+' => 'Sekundäre / redundante Einspeisung (B).',
